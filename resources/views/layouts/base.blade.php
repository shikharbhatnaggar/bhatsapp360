...
<head>
    ...
    <title>@yield('title', 'Bhatsapp')</title>
    <link rel="icon" type="image/png" href="{{ asset('images/bhatsapp-logo.png') }}">
    <link rel="apple-touch-icon" href="{{ asset('images/bhatsapp-logo.png') }}">
